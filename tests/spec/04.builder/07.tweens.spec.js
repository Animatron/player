                    ...
                    describe("default implementation", function() {
                        ...
                        describe("will override x/y values with ones from the last modifier of the state according to given direction", function() {
                            ...
                            describe("non-overlapping bands", function() {
                                ...
                                it("works with tweens that were added in wrong order", function() {
                                    checkTweens([.15, 2],
                                                [ [ 'trans', [ 1.1, 1.85 ], [[3, 19], [8.4, -11]] ],
                                                  [ 'trans', [  .3,   .9 ], [[6,  4], [9,    15]] ] ],
                                                function(s, at) {
                                ...
                                it("works with sequential tweens", function() {
                                    checkTweens([.2, 1.8],
                                                ...
                                                function(s, at) {
                                                    ...
                                                    // during both tweens
                                                    if (at < (.2 + .9)) {
                                                        expect(s.x).toBeCloseTo(bs.x +  5 + (((at - .12 - .2) / (  .9 - .12)) * (3.2 -    5))
                                                                                     + -1 + (((at -  .5 - .2) / (1.56 -  .5)) * (  0 - (-1))), CLOSE_FACTOR);
                                                        expect(s.y).toBeCloseTo(bs.y + 12 + (((at - .12 - .2) / (  .9 - .12)) * ( 40 -   12))
                            ...
                            it("works with more than two tweens", function() {
                                checkTweens([.1, 3],
                                            ...
                                            function(s, at) {
                                                ...
                                                if (at < (.1 + 1.5)) {
                                                    expect(s.x).toBeCloseTo(bs.x + 7 + (((at -   1 - .1) / (1.5 -   1)) * ( 9 - 7))
                                                                                 + 9 + (((at - 1.3 - .1) / (  2 - 1.3)) * (11 - 9)), CLOSE_FACTOR);
                                                    expect(s.y).toBeCloseTo(bs.y + 7 + (((at -   1 - .1) / (1.5 -   1)) * (11 - 7))
                                                                                 + 8 + (((at - 1.3 - .1) / (  2 - 1.3)) * (22 - 8)), CLOSE_FACTOR);
                                                    return true;
                                                }
                                ...
                                it("works with sequential tweens", function() {
                                    checkTweens([.2, 1.8],
                                                ...
                                                function(s, at) {
                                                    ...
                                                    // during both tweens
                                                    if (at < (.2 + .9)) {
                                                        expect(s.sx).toBeCloseTo(bs.sx +  5 + (((at - .12 - .2) / (  .9 - .12)) * (3.2 -    5))
                                                                                       + -1 + (((at -  .5 - .2) / (1.63 -  .5)) * (  0 - (-1))), CLOSE_FACTOR);
                                                        expect(s.sy).toBeCloseTo(bs.sy + 12 + (((at - .12 - .2) / (  .9 - .12)) * ( 40 -   12))
                                                                                       +  9 + (((at -  .5 - .2) / (1.63 -  .5)) * ( 16 -    9)), CLOSE_FACTOR);
                                                        return true;
                                                    }
                                                    // during the second tween, but after the first one
                                                    if (at < (.2 + 1.63)) {
                            ...
                            it("works with more than two tweens", function() {
                                checkTweens([.1, 3],
                                            ...
                                            function(s, at) {
                                                ...
                                                // during both the second and the third tweens
                                                if (at < (.1 + 1.5)) {
                                                    expect(s.sx).toBeCloseTo(bs.sx + 7 + (((at -   1 - .1) / (1.5 -   1)) * ( 9 - 7))
                                                                                   + 9 + (((at - 1.3 - .1) / (  2 - 1.3)) * (11 - 9)), CLOSE_FACTOR);
                                                    expect(s.sy).toBeCloseTo(bs.sy + 7 + (((at -   1 - .1) / (1.5 -   1)) * (11 - 7))
                                                                                   + 8 + (((at - 1.3 - .1) / (  2 - 1.3)) * (22 - 8)), CLOSE_FACTOR);
                                                    return true;
                                                }
                                                // during the third tween, but after the secod one
                    ...
                    describe("will change sx/sy values of the state according to given values", function() {
                        ...
                        it("works in case of simple values", function() {
                            checkTweens([0, 1],
                                        [ [ 'xscale', [ 0, 1 ], [2, 20] ] ],
                                        function(s, at) {
                                            expect(s.sx).toBeCloseTo(b.sx + (2 * (1.0 - at)) + (20 * at), CLOSE_FACTOR);
                                            expect(s.sy).toBeCloseTo(b.sy + (2 * (1.0 - at)) + (20 * at), CLOSE_FACTOR);
                                        });
                        });
                        ...
                        it("works in case of mixed values (incl. negative)", function() {
                            checkTweens([0, 1],
                                        [ [ 'xscale', [ 0, 1 ], [-1, 3] ] ],
                                        function(s, at) {
                                            expect(s.sx).toBeCloseTo(b.sx + ((-1) * (1.0 - at)) + (3 * at), CLOSE_FACTOR);
                                            expect(s.sy).toBeCloseTo(b.sy + ((-1) * (1.0 - at)) + (3 * at), CLOSE_FACTOR);
                                        });
                        });
                        ...
                        it("works in case of floating values", function() {
                            checkTweens([0, 1],
                                        [ [ 'xscale', [ 0, 1 ], [6, 14.7] ] ],
                                        function(s, at) {
                                            expect(s.sx).toBeCloseTo(b.sx + (6 * (1.0 - at)) + (14.7 * at), CLOSE_FACTOR);
                                            expect(s.sy).toBeCloseTo(b.sy + (6 * (1.0 - at)) + (14.7 * at), CLOSE_FACTOR);
                                        });
                        });
                                ...
                                it("works with sequential tweens", function() {
                                    checkTweens([.2, 1.8],
                                                ...
                                                function(s, at) {
                                                    ...
                                                    // during both tweens
                                                    if (at < (.2 + .9)) {
                                                        expect(s.sx).toBeCloseTo(bs.sx + 3.2 + (((at - .12 - .2) / (  .9 - .12)) * (40 - 3.2))
                                                                                       +  .2 + (((at - .54 - .2) / (1.63 -  .5)) * (16 -  .2)), CLOSE_FACTOR);
                                                        expect(s.sy).toBeCloseTo(bs.sy + 3.2 + (((at - .12 - .2) / (  .9 - .12)) * (40 - 3.2))
                                                                                       +  .2 + (((at - .54 - .2) / (1.63 -  .5)) * (16 -  .2)), CLOSE_FACTOR);
                                                        return true;
                                                    }
                                                    // during the second tween, but after the first one
                            ...
                            it("works with more than two tweens", function() {
                                checkTweens([.1, 3],
                                            ...
                                            function(s, at) {
                                                ...
                                                // during both the second and the third tweens
                                                if (at < (.1 + 1.5)) {
                                                    expect(s.sx).toBeCloseTo(bs.sx + 7 + (((at -   1 - .1) / (1.5 -   1)) * (11 - 7))
                                                                                   + 9 + (((at - 1.3 - .1) / (  2 - 1.3)) * (22 - 9)), CLOSE_FACTOR);
                                                    expect(s.sy).toBeCloseTo(bs.sy + 7 + (((at -   1 - .1) / (1.5 -   1)) * (11 - 7))
                                                                                   + 9 + (((at - 1.3 - .1) / (  2 - 1.3)) * (22 - 9)), CLOSE_FACTOR);
                                                    return true;
                                                }
                                    ...
                                    checkTweens([.2, 1.8],
                                                ...
                                                function(s, at) {
                                                    ...
                                                    if (at < (.2 + .9)) {
                                                        ...
                                                        var adt2 = (at - .54 - .2) / (1.63 - .54);
                                                        expect(s.angle).toBeCloseTo(bs.angle + (3.14 * (1.0 - adt1)) + ((  2 * Math.PI  ) * adt1)
                            ...
                            it("works with more than two tweens", function() {
                                ...
                                checkTweens([.1, 3],
                                            ...
                                            function(s, at) {
                                                ...
                                                // during both the second and the third tweens
                                                if (at < (.1 + 1.5)) {
                                                    var adt1 = (at -   1 - .1) / (1.5 -   1);
                                                    var adt2 = (at - 1.3 - .1) / (  2 - 1.3);
                                                    expect(s.angle).toBeCloseTo(bs.angle + ( Math.PI          * (1.0 - adt1)) + (( Math.PI / 2 ) * adt1)
                                                                                         + ((Math.PI * 5 / 4) * (1.0 - adt2)) + ((1.9 * Math.PI) * adt2), CLOSE_FACTOR);
                                                    return true;
                                                }
                                                // during the third tween, but after the secod one
                                                if (at < (.1 + 2)) {
                                    ...
                                    checkTweens([.2, 1.8],
                                                ...
                                                function(s, at) {
                                                    ...
                                                    if (at < (.2 + .9)) {
                                                        var adt1 = (at - .12 - .2) / (  .9 - .12);
                                                        var adt2 = (at - .54 - .2) / (1.63 - .54);
                                                        expect(s.alpha).toBeCloseTo(bs.alpha + (.25 * (1.0 - adt1)) + ( 5 * adt1)
                                ...
                                checkTweens([.1, 3],
                                            ...
                                            function(s, at) {
                                                ...
                                                if (at < (.1 + 1.5)) {
                                                    var adt1 = (at -   1 - .1) / (1.5 -   1);
                                                    var adt2 = (at - 1.3 - .1) / (  2 - 1.3);
                                                    expect(s.alpha).toBeCloseTo(bs.alpha + (.5 * (1.0 - adt1)) + ( .8 * adt1)
                                                                                         + (.6 * (1.0 - adt2)) + (.97 * adt2), CLOSE_FACTOR);
                                                    return true;
                                                }
                                                // during the third tween, but after the secod one
                                                if (at < (.1 + 2)) {

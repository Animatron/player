        ...
        describe("the way tweens apply, by type", function() {
            ...
            describe("translate tween", function() {
                ...
                describe("single one", function() {
                    ...
                    describe("should change x/y values of the state according to given direction", function() {
                ...
                describe("several ones", function() {
                    ...
                    describe("default implementation", function() {
                        ...
                        describe("should override x/y values with ones from the last modifier of the state according to given direction", function() {

                            it("works with non-overlapping bands, last-added modifier goes just after the first in timeline", function() {
                                checkTweens([.15, 2],
                                            [ [ 'trans', [  .3,   .9 ], [[6,  4], [9,    15]] ],
                            ...
                            it("works with non-overlapping bands, last-added modifier goes just before the first in timeline", function() {
                                checkTweens([.15, 2],
                                            [ [ 'trans', [ 1.1, 1.85 ], [[3, 19], [8.4, -11]] ],
                                              [ 'trans', [  .3,   .9 ], [[6,  4], [9,    15]] ] ],
                                            function(s, at) {
                            ...
                            it("works with overlapping bands, last-added modifier starting point goes after the first in timeline", function() {
                                checkTweens([.2, 1.8],
                            ...
                            it("works with overlapping bands, last-added modifier starting point goes before the first in timeline", function() {
                                checkTweens([.2, 1.8],
                                            [ [ 'trans', [ .5,  1.56 ], [[-1,  9], [0,   16]] ],
                                              [ 'trans', [.12,    .9 ], [[ 5, 12], [3.2, 40]] ] ],
                                            function(s, at) {
                            ...
                            it("works with more than two tweens", function() {
                                checkTweens([.1, 3],
                                            ...
                                            function(s, at) {
                                                ...
                                                // during the tween
                                                expect(s.x).toBeCloseTo(9 + (((at - 1.5 - .1) / (2 - 1.5)) * (11 - 9)), CLOSE_FACTOR);
                                                expect(s.y).toBeCloseTo(8 + (((at - 1.5 - .1) / (2 - 1.5)) * (22 - 8)), CLOSE_FACTOR);
                                            });
                            });

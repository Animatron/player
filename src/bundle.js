...
},{"./anm/conf.js":2,"./anm/constants.js":3,"./anm/errors.js":4,"./anm/events.js":5,"./anm/importers.js":6,"./anm/is.js":7,"./anm/iter.js":8,"./anm/loc.js":9,"./anm/log.js":10,"./anm/modules.js":11,"./anm/player_manager.js":12,"./anm/resource_manager.js":13,"./engine/dom-engine.js":14}],2:[function(require,module,exports){
(function (global){
...
},{"./conf.js":2,"./constants.js":3}],11:[function(require,module,exports){
// Modules
// -----------------------------------------------------------------------------
var M = {};
...
},{"./constants.js":3,"./events.js":5}],13:[function(require,module,exports){
// Resource manager
// -----------------------------------------------------------------------------
...
},{"./conf.js":2,"./is.js":7,"./log.js":10}],14:[function(require,module,exports){
(function (global){
/*
 * Copyright (c) 2011-@COPYRIGHT_YEAR by Animatron.
 * All rights are reserved.
...
Player.prototype._postInit = function() {
    ...
    if (to_load.url) {
        this.load(to_load.url,
                  (to_load.importer_id) && anm.I.isAccessible(to_load.importer_id)
                  ? anm.I.create(to_load.importer_id) : null);
    }
}
/**
 * @method changeRect
...
L.loadFromUrl = function(player, url, importer, callback) {
    ...
    var importer = importer || anm.I.create('animatron');
